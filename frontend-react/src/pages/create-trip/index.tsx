...
export function CreateTripPage() {
  ...
  const [emailsToInvite, setEmailsToInvate] = useState([
    'robson14br@outlook.com',
    'raires.leite@outlook.com'
  ])
      ...
      <div className="max-w-3xl w-full px-6 text-center space-y-10 ">
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-sm text-zinc-500">
            ...
            com nossos <a className="text-zinc-300 underline" href="#"> termos de uso </a> e <a className="text-zinc-300 underline" href="#">
                ...
                <div className="flex items-center justify-between">
                  <h2 className="text-lg font-semibold">Confirmar criação de viagem</h2>
                   ...
                   <X className="size-5 text-zinc-400" />
                     ...
                     <p className="text-sm text-zinc-400 ">
                      Para concluir a crianção da viagem para <span className="font-semibold text-zinc-100">Florianopolis, Brasil</span > nas datas de <span className="font-semibold text-zinc-100">16 a 27 de Agosto de 2024</span> preencha seus dados abaixo:
                      </p>
                    </div>
